  ...
  return (
    <div className="animate-in slide-in-from-bottom-6 duration-500 pt-0 pb-4">
      ...
      <div className="space-y-4 px-1">
        <section>
          <label className="text-[9px] font-black tracking-widest text-zinc-400 uppercase mb-1.5 block ml-1">KASA VE TARİH SEÇİMİ</label>
          <div className="grid grid-cols-2 gap-3">
             <div className="flex flex-col">
                <label className="text-[8px] font-black text-zinc-500 uppercase tracking-[0.1em] mb-1 block text-center">GELİR TARİHİ</label>
                <input 
                  type="date" 
                  value={formData.date} 
             ...
             <div className="flex flex-col bg-white/5 p-1 rounded-xl border border-white/5">
                <label className="text-[8px] font-black text-zinc-500 uppercase tracking-[0.1em] mb-1 block text-center">KASA TÜRÜ</label>
                <div className="grid grid-cols-2 gap-1 flex-1">
                  ...
                  <button onClick={() => setFormData(prev => ({...prev, kasa: 'demirbas'}))} className={`rounded-lg flex items-center justify-center transition-all ${formData.kasa === 'demirbas' ? 'bg-blue-600 text-white' : 'text-zinc-500'}`}>
                    <span className="text-[9px] font-black uppercase">DEMİR</span>
                  </button>
                </div>
             </div>
          </div>
        ...
        <section className="relative max-w-[265px] mx-auto group">
          <label className="text-[9px] font-black tracking-widest text-zinc-400 uppercase mb-1 block text-center">GELİR KALEMİ</label>
          <button 
        ...
        <section className="bg-slate-800/40 rounded-2xl p-4 border border-white/5 shadow-2xl">
          <div className="grid grid-cols-2 gap-3 mb-3">
             <div className="flex flex-col">
                <label className="text-[9px] font-black tracking-widest text-zinc-500 uppercase mb-1 block text-center">GELİR TUTARI (₺)</label>
                <input 
                  type="number" 
                  placeholder="0.00" 
             ...
             <div className="flex flex-col">
                <label className="text-[9px] font-black tracking-widest text-zinc-500 uppercase mb-1 block text-center italic">GELİR TARİHİ</label>
          ...
          <div>
            <label className="text-[9px] font-black tracking-widest text-zinc-500 uppercase mb-1 block ml-1">İŞLEM AÇIKLAMASI</label>
            <input 
              type="text" 
        ...
        >
          {isSaving ? <Loader2 className="animate-spin" size={20} /> : (
            <>
              <span className="text-[14px] font-black text-white uppercase tracking-[0.2em]">İŞLEMİ ONAYLA</span>
              <Save size={18} />
            </>
          )}
        </button>
